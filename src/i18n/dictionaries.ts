...
const fr = {
  ...
  "atelier.fiche.field.intent": "Note d'intention",
  ...
  "atelier.fiche.f.intent_note_fr": "note d'intention",
...
const en: Record<DictKey, string> = {
  ...
  "atelier.fiche.field.intent": "Intent note",
  ...
  "atelier.fiche.f.intent_note_fr": "intent note",
